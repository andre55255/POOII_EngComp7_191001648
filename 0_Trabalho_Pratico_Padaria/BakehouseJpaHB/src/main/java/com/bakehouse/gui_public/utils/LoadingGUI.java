...
public class LoadingGUI extends javax.swing.JFrame {
    ...
    public LoadingGUI() {
        ...
        UIManager.put("ProgressBar.foreground", new Color(250, 150, 0));
        UIManager.put("ProgressBar.selectionBackground", new Color(250, 150, 0));
        UIManager.put("ProgressBar.selectionForeground", new Color(250, 150, 0));
        initComponents();
    }
