 ...
 private Component component;
    ...
    public void success() {
        JOptionPane.showMessageDialog(component, 
                ...
                this.getIcon("/com/store/assets/ico-alert-success.png", 40, 40));
    }
    ...
    public void error() {
        JOptionPane.showMessageDialog(component, 
                ...
                "Erro", 
                JOptionPane.PLAIN_MESSAGE,
                this.getIcon("/com/store/assets/ico-alert-error.png", 40, 40));
    }
    ...
    public void warning() {
        JOptionPane.showMessageDialog(component, 
                ...
                "Aviso", 
                JOptionPane.PLAIN_MESSAGE,
                this.getIcon("/com/store/assets/ico-alert-warning.png", 40, 40));
    }   
}